...
// Example: Retrieve members from the database
            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Display members from the database -->
                        <table class="table">
                            <thead>
                                <tr>
                                    <th>Name</th>
                            ...
                            <tbody>
                                <?php
                                // Loop through the retrieved members and display them
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<td><a href='edit_member.php?id=" . $row["id"] . "' class='btn btn-primary'>Edit</a> <a href='delete_member.php?id=" . $row["id"] . "' class='btn btn-danger'>Delete</a></td>";
                                        echo "</tr>";
                                    }
                                } else {
